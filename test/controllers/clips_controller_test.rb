...
class ClipsControllerTest < ActionController::TestCase
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post :create, clip: { category: @clip.category, description: @clip.description, level: @clip.level, path: @clip.path, title: @clip.title }
    end
  ...
  test "should update clip" do
    patch :update, id: @clip, clip: { category: @clip.category, description: @clip.description, level: @clip.level, path: @clip.path, title: @clip.title }
    assert_redirected_to clip_path(assigns(:clip))
  end
